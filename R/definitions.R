...
# ALSFRS-R, vraag 5 indien zowel vraag 5a als vraag 5b ingevuld is, kies ik er voor om vraag 5b te gebruiken
# aangezien die alleen ingevuld kan worden als patient daadwerkelijk een PEG heeft.  Uiteraard ook
# registreren of je vraag 5a of 5b gebruikt hebt Let op! data wordt 'in place' gemodificeerd. Wegschrijven
# naar een (nieuw) object is dus niet nodig.
